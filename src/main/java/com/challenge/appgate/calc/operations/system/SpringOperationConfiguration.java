...
public class SpringOperationConfiguration {
    @Bean
    public OperationExecutor operationExecutor(OperandsFinder operandsFinder, UserRepository userRepository) {
        return new OperationExecutor(operandsFinder, userRepository);
    }
